      ...
      <div class=" card col-md-6 offset-md-3">
        <div class="panel panel-default" style="padding: 20px;">
          ...
          <div class="mb-3">
              ...
              <input type="text" class="form-control"placeholder="NID No" id="" name="NID_No"; ?>
            </div><br>
        ...
        <?php
          ...
          if(isset($_POST['Search']))
          {
            ...
            $sql= "Select * FROM nid WHERE NID_No='$NID_No'";
            ...
            { ?>
              ...
              <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">NID No :</label>
              <input type="text" class="form-control"placeholder="NID No" id="" name="NID_No" value="<?php echo $row["NID_No"]; ?>"required>
            </div>
            <div class="mb-3">
...
if (isset($_POST["update"])) {
  ...
  $Date_of_birth = mysqli_real_escape_string($conn, $_POST["Date_of_birth"]);
    ...
    $sql = "UPDATE `nid` SET `NID_No` = '$_POST[NID_No]', `Name` = '$_POST[Name]', `Present_Address` = '$Present_Address',
     `Permanent_Address` = '$_POST[Permanent_Address]',`Date_of_birth` = '$_POST[Date_of_birth]'
     WHERE `nid`.`NID_No` = '$_POST[NID_No]'";
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $_POST["NID_No"] = "";
      $_POST["Name"] = "";
