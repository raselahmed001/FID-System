...
if (isset($_POST["submit"])) {	
  ...
  //check the email
  $check = mysqli_num_rows(mysqli_query($conn, "SELECT Passport_No FROM passport WHERE Passport_No='$Passport_No'"));

  if ($check > 0) {
    echo "<script>alert('Data already Exists in out Database.');</script>";
  } else {
    $sql = "INSERT INTO `passport`(`Passport_No`, `Name`, `Present_Address`, `Permanent_Address`, `Date_of_birth`,`Phone_No`) 
    VALUES ('$Passport_No','$Name','$Present_Address','$Permanent_Address','$Date_of_birth','$Phone_No')";
...
<head>
  ...
  <title>ADD Citizen Passport</title>
</head>
...
<nav class="navbar navbar-inverse">
  ...
  <hr>
  <div class="beadonor">
    <h3 style="color:#FF0000 ;" class="some">Add Citizen Passport</h3>
  </div>
        ...
        <div class="panel panel-default" style="padding: 20px;">
          ...
          <form action="" method="post" class="form-group form-container">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control"placeholder="Passport No" id="" name="Passport No" value="<?php echo $_POST["Passport_No"]; ?>"required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="exampleInput" class="form-label">Phone No :</label>
              <input type="text" class="form-control" placeholder="Phone No" id="" name="Phone No" value="<?php echo $_POST["Phone_No"]; ?>" required>
            </div>
            <br>
