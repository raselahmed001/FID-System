...
if (isset($_POST["search"])) {
  ...
  $NID_No = mysqli_real_escape_string($conn, $_POST["NID_No"]);
     $sql = "Select * FROM driving_lisence WHERE NID_No='$NID_No' ";
    ...
    <div class="row">
      <div class=" card col-md-6 offset-md-3">
        <div class="panel panel-default" style="padding: 20px;">
          ...
          <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Citizen NID No :</label>
              <input type="text" class="form-control"placeholder="Enter NID No" id="" name="NID_No" value="<?php echo $_POST["NID_No"]; ?>"required>
            </div><br>
